...
class KlassesControllerTest < ActionController::TestCase
  ...
  test "should create klass" do
    assert_difference('Klass.count') do
      post :create, klass: { date: @klass.date, description: @klass.description, place: @klass.place, price: @klass.price, teacher: @klass.teacher, time: @klass.time, title: @klass.title }
    end
  ...
  test "should update klass" do
    patch :update, id: @klass, klass: { date: @klass.date, description: @klass.description, place: @klass.place, price: @klass.price, teacher: @klass.teacher, time: @klass.time, title: @klass.title }
    assert_redirected_to klass_path(assigns(:klass))
  end
